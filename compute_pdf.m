...
if single_gauss
    ...
    for i=1:length(D.ma)
        ...
        if sum(da.*D.pdf(i,:)) - 1 > 0.01
            ...
            % this was happening sometimes in the low-variance case. If you remove this error, things should run to completetion, but the variance of the posterior distribution is sometimes wrong. Proceed carefully!
                disp('Warning hitting weird case with integral summation and not just a 1-bin thing. Are you in the low-variance case?')
            end
